...
export default function Irrigation() {
  return (
    <div className="container irrigation">
      ...
      <ul>
        <li>Maximum use of available water.</li>
        <li>No water being available to weeds.</li>
        <li>Maximum crop yield.</li>
        <li>High efficiency in the use of fertilizers.</li>
        <li>Less weed growth and restricts population of potential hosts.</li>
        <li>Low labour and relatively low operation cost.</li>
        <li>No soil erosion.</li>
      </ul>
      <p>Drip irrigation is <b>the most efficient water and nutrient delivery system for growing crops</b>. It delivers water and nutrients directly to the plant's roots zone, in the right amounts, at the right time, so each plant gets exactly what it needs, when it needs it, to grow optimally.
      </p>
      <p>Drip irrigation can use either <b>PVC pipe or polyethylene tubing</b> (or a combination of both). PVC systems are usually reserved for larger‐scale applications (like farming), while polyethylene tubing is the choice for home gardening.</p>

      <h4>Porous Soaker Hose</h4>
      <p>This is one of the best drip irrigation methods to use to get water to rows of shrubs or plant beds. It produces the least among of evaporation because it allows the soil to absorb all of the water it releases. It directs the water to plant roots.</p>
      <p>Drip runs longer than other irrigation types — <b>45-60-minute</b> run times are not uncommon — so any leaks are magnified over a long run cycle.</p>
      <p><b>Drip irrigation systems will use less water and reduce waste</b>. Saving water and reducing consumption is important these days, and if that is high up on your list as well, then you may want to go with a drip irrigation system.
      </p>
